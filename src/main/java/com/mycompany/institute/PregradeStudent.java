 ...
 * @author Andres Gomez
 */
public class PregradeStudent extends Estudiante{
    private String nom;
    ...
    public PregradeStudent(String nom, String cedula, String sexo) {
        this.nom = nom;
        this.cedula = cedula;
        this.sexo = sexo;
        this.setTipomatricula(new MatriculaPre());
    }
    ...
    public String toString() {
        return "PregradeStudent{" + "nom=" + nom + ", cedula=" + cedula + ", sexo=" + sexo + ", cred=" + cred + ", calculo=" + calculo + ", fisica=" + fisica + ", estadistica=" + estadistica + '}';
    }
